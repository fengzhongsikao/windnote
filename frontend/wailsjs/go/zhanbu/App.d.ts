...
export function DeleteDivinationRecord(arg1:string):Promise<void>;

export function DeleteMeihuaRecord(arg1:string):Promise<void>;

export function FetchLunarData():Promise<string>;
